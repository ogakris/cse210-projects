...
class Program
{
    static void Main(string[] args)
    {
        ...
        video1.AddComment(new Comment("Ama", "Great introduction to C#!"));
        video1.AddComment(new Comment("Bob", "Super helpful, thanks for uploading."));
        video1.AddComment(new Comment("Charles", "Can you cover async/await next?"));

        // Add Comments to Video 2
        video2.AddComment(new Comment("Dede", "Abstraction finally makes sense to me."));
        video2.AddComment(new Comment("Kwesi", "Awesome explanations and diagrams."));
        ...
        video3.AddComment(new Comment("Hilda", "Lists are so much cleaner than arrays."));
        video3.AddComment(new Comment("Ivy", "Short and straight to the point."));
        video3.AddComment(new Comment("Jude", "Loved the code examples."));

        // Add Comments to Video 4
        video4.AddComment(new Comment("Max", "Installed three of these immediately!"));
